...
contract SmartCoin is Whitelist, ERC20, ISmartCoin {
    ...
    function validateTransfer(bytes32 transferHash)
        ...
        returns (bool)
    {
        TransferRequest storage _transferRequest = _transfers[transferHash];
        require(
        ...
        _transferRequest.status = TransferStatus.Validated;
        if (_transferRequest.isTransferFrom) {
            require(whitelist[_transferRequest.spender], "Whitelist: address must be whitelisted");
        }
        require(_engagedAmount[_transferRequest.from] >= _transferRequest.value, "SmartCoin: Insufficient engagedAmount amount");
        ...
        returns (bool)
    {
        ...
        require(
            _to != address(0) && _to != _msgSender(),
            "SmartCoin:  approve spender is the zero address or the owner"
        );
        require(
    ...
    function transferFrom(
        ...
        returns (bool)
    {
        require(_from != _to, "SmartCoin: transfer from and to the same address");
        unchecked {
    ...
    function transfer(address _to, uint256 _value)
        ...
        returns (bool)
    {
        require(_to != _msgSender(), "SmartCoin: transfer to the same address");
